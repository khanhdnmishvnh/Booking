...
if ($data) {
    ...
    $mailer = new Mailer();
    $mail = $mailer->sendConfirmation($customer_email, $room_name, $check_in, $check_out, $order_id, $customer_name, $customer_phone, $customer_address, $payment, $qrPath, $room_image_path);
