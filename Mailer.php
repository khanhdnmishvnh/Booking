...
class Mailer {
    ...
    public function sendConfirmation($email, $roomName, $checkIn, $checkOut, $orderId, $name, $phone, $address, $amount, $qrPath, $roomImagePath) {
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <img src="cid:room_image" alt="Room Image" width=200px >
                    </div>
                        <div class="details">
                            <ul>
